...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0485bce1bac0d543f104cbff2bd23680056a3b9ea05e1137d2ff90eeb5e08472eb500322593a2cb06fbf8297d7beb6cd30cb90f98153b5b7cce1493749e41e0284");
        nDefaultPort = 28154;
        nRPCPort = 28155;
        bnProofOfWorkLimit = CBigNum(~uint256(0) >> 20);

        const char* pszTimestamp = "Neodark Next Revolution";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1511260843, vin, vout, 0);
        ...
        nLastPOWBlock = 12500; //then its PURE POS.
    }
