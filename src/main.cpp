...
#if defined(NDEBUG)
# error "Neodark cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Neodark Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
	...
	if (nHeight <= 3)
		...
		nSubsidy = 1 * COIN;  //until Block 260 000
...
#ifdef ENABLE_WALLET
// Neodark: attempt to generate suitable proof-of-stake
